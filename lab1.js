...
//your code goes here
//assert('lions' > 'apes', 'a comes before l, this assert will pass. The lion is the king of the jungle, not the ape.');
//assert('frogs' === 'reptiles', 'this is a failing assertion, the  strings are not the same, and frogs are amphibians');
...
// your code goes here
var newSentence1 = sentence1.split(' ');
for (var i = 0; i < newSentence1.length; i++) {
  newSentence1[i] = 'chirp';
}

sentence1 = newSentence1.join(' ') + '.';

// TODO: part #2: use a while or do-while loop to replace the words in sentence 2
// with 'chirp' (10 points)

// your code goes here
var newSentence2 = sentence2.split(' ');
while (i < 9) {
  newSentence2[i] = 'chirp';
}

sentence2 = newSentence2.join(' ') + '.';
...
assert(animalExhibitStats.mostPopular === 'Lucky the Emperor Penguin', 'Lucky is always the favorite...');
/* ==================================================================
